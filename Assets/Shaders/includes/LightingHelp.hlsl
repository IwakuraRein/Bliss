#ifndef LIGHTING_HELP_HLSL
#define LIGHTING_HELP_HLSL


float _ComputeFogFactor(float clipZ_01)
{
...
void ApplyFog(inout float3 color, float distance)
{
    float fogFactor = _ComputeFogFactor(distance);
